...
const config :Workerd.Config = (
  services = [
    (name = "moonphase", worker = .moonphaseWorker),
  ],
  sockets = [
    (name = "http", address = "*:8790", http = (), service = "moonphase"),
  ],
);

const moonphaseWorker :Workerd.Worker = (
  modules = [
  ...
  durableObjectNamespaces = [
    (className = "MatchBoxWebSocketDO", uniqueKey = "do-matchbox-moonphase", enableSql = true),
  ],
