...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_964: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly __wasm_bindgen_func_elem_961: (a: number, b: number, c: number, d: number) => number;
    readonly __wasm_bindgen_func_elem_962: (a: number, b: number, c: number, d: number) => number;
    readonly __wasm_bindgen_func_elem_4481: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4495: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_960: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_963: (a: number, b: number, c: number) => void;
