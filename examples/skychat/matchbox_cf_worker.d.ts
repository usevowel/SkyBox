 ...
 */
export function vm_on_connect(connection_id: string, request_json: string): string;
 ...
 */
export function vm_on_message(connection_id: string, msg_type: number, message: Uint8Array): string;
...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_538: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_3903: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_952: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly __wasm_bindgen_func_elem_949: (a: number, b: number, c: number, d: number) => number;
    readonly __wasm_bindgen_func_elem_950: (a: number, b: number, c: number, d: number) => number;
    readonly __wasm_bindgen_func_elem_4469: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4483: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_948: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_951: (a: number, b: number, c: number) => void;
