...
const config :Workerd.Config = (
  services = [
    (name = "chatroom", worker = .chatroomWorker),
  ],
  sockets = [
    (name = "http", address = "*:8789", http = (), service = "chatroom"),
  ],
);

const chatroomWorker :Workerd.Worker = (
  modules = [
  ...
  durableObjectNamespaces = [
    (className = "MatchBoxWebSocketDO", uniqueKey = "do-matchbox-chatroom", enableSql = true),
  ],
